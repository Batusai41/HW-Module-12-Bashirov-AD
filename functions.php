...
$example_persons_array = [
    ...
    [
        'fullname' => 'Баширов Антон Дамирович',
        'job' => 'student',
    ],
];

//выбираем ФИО из массива случайным образом
$persons = $example_persons_array[random_int(0, count($example_persons_array) - 1)]['fullname'];        //это строка

//Разбиение и объединение ФИО
function getPartsFromFullname ($persons) {
    
   $arrayPersonFullName = explode(" ", $persons);
   global $fullname;
...
{
    $x = getPartsFromFullname($persons);
    global $reduction;
